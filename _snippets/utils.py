data = {
    ...
    "math库.atan2:计算给定坐标 (x, y) 的反正切值。": {
        "prefix": "math.atan2",
        "body": "math.atan2(${2:x},${1:y})",
        "description": " ※参数: \n   (x)<num>[x 坐标] \n   (y)<num>[y 坐标] \n ※返回: <num>[反正切值] \n ※说明: 计算给定坐标 (x, y) 的反正切值。\n ※贡献者: @lan"
    },
    "math库.log:计算自然对数。": {
        "prefix": "math.log",
        "body": "math.log(${2:base},${1:x})",
        "description": " ※参数: \n   (base)<num>[底数（可选，默认为 e）] \n   (x)<num>[数值] \n ※返回: <num>[自然对数或以 base 为底的对数] \n ※说明: 计算自然对数。\n ※贡献者: @lan"
    },
    "math库.abs:计算绝对值。": {
        "prefix": "math.abs",
        "body": "math.abs(${1:x})",
    ...
    "math库.min:计算最小值。": {
        "prefix": "math.min",
        "body": "math.min(${2:y},${1:x})",
        "description": " ※参数: \n   (y)<num>[数值] \n   (x)<num>[数值] \n ※返回: <num>[最小值] \n ※说明: 计算最小值。\n ※贡献者: @lan"
    },
    "math库.ldexp:计算 x * 2^n 的值。": {
        "prefix": "math.ldexp",
        "body": "math.ldexp(${2:n},${1:x})",
        "description": " ※参数: \n   (n)<num>[指数] \n   (x)<num>[基数] \n ※返回: <num>[x * 2^n 的结果] \n ※说明: 计算 x * 2^n 的值。\n ※贡献者: @lan"
    },
    "math库.pow:计算 x 的 y 次方。": {
        "prefix": "math.pow",
        "body": "math.pow(${2:y},${1:x})",
        "description": " ※参数: \n   (y)<num>[指数] \n   (x)<num>[基数] \n ※返回: <num>[x 的 y 次方] \n ※说明: 计算 x 的 y 次方。\n ※贡献者: @lan"
    },
    "math库.deg:将弧度转换为角度。": {
        "prefix": "math.deg",
