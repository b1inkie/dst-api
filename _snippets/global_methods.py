data = {
    ...
    "全局.IsDLCEnabled:UNKNOWN": {
        ...
        "description": " ※参数: \n   (index)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/dlcsupport_worldgen 所在行数: 12"
    },
    "全局.DistXZSq:UNKNOWN": {
        "prefix": "DistXZSq",
    ...
    "全局.GetTick:UNKNOWN": {
        "prefix": "GetTick",
        "body": "GetTick(${1:})",
        "description": " ※参数: \n   ()<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 547"
    },
    ...
    "全局.GetModConfigData:UNKNOWN": {
        "prefix": "GetModConfigData",
        "body": "GetModConfigData(${1:optionname},${2:modname},${3:get_local_config})",
        "description": " ※参数: \n   (optionname)<>[] \n   (modname)<>[] \n   (get_local_config)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/modutil 所在行数: 34"
    },
    ...
    "全局.GetShardModRPCHandler:UNKNOWN": {
        ...
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1591"
    },
    ...
    "全局.GetStaticTick:UNKNOWN": {
        ...
        "description": " ※参数: \n   ()<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 551"
    },
    ...
    "全局.AddCookerRecipe:UNKNOWN": {
        ...
        "body": "AddCookerRecipe(${1:cooker},${2:recipe},${3:is_mod_food})",
        "description": " ※参数: \n   (cooker)<>[] \n   (recipe)<>[] \n   (is_mod_food)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/cooking 所在行数: 9"
    },
    ...
    "全局.AddModRPCHandler:UNKNOWN": {
        "prefix": "AddModRPCHandler",
        "body": "AddModRPCHandler(${1:namespace},${2:name},${3:fn})",
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n   (fn)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1461"
    },
    ...
    "全局.GetTickTime:UNKNOWN": {
        "prefix": "GetTickTime",
        "body": "GetTickTime(${1:})",
        "description": " ※参数: \n   ()<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 534"
    },
    ...
    "全局.LoadScript:UNKNOWN": {
        ...
        "description": " ※参数: \n   (filename)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 566"
    },
    "全局.HexToRGB:UNKNOWN": {
        "prefix": "HexToRGB",
        "body": "HexToRGB(${1:hex})",
    ...
    "全局.RegisterScrapbookIconAtlas:UNKNOWN": {
        ...
        "body": "RegisterScrapbookIconAtlas(${1:atlas},${2:imagename})",
        "description": " ※参数: \n   (atlas)<>[] \n   (imagename)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/simutil 所在行数: 680"
    },
    ...
    "全局.GetTime:UNKNOWN": {
        "prefix": "GetTime",
        "body": "GetTime(${1:})",
        "description": " ※参数: \n   ()<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 539"
    },
    ...
    "全局.GetClientModRPC:UNKNOWN": {
        ...
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1599"
    },
    ...
    "全局.AddClientModRPCHandler:UNKNOWN": {
        "prefix": "AddClientModRPCHandler",
        "body": "AddClientModRPCHandler(${1:namespace},${2:name},${3:fn})",
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n   (fn)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1478"
    },
    ...
    "全局.GetStaticTime:UNKNOWN": {
        ...
        "description": " ※参数: \n   ()<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 543"
    },
    ...
    "全局.GetModRPCHandler:UNKNOWN": {
        ...
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1583"
    },
    ...
    "全局.GetModRPC:UNKNOWN": {
        ...
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1595"
    },
    ...
    "全局.AddShardModRPCHandler:UNKNOWN": {
        "prefix": "AddShardModRPCHandler",
        "body": "AddShardModRPCHandler(${1:namespace},${2:name},${3:fn})",
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n   (fn)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1493"
    },
    ...
    "全局.SendModRPCToServer:UNKNOWN": {
        "prefix": "SendModRPCToServer",
        "body": "SendModRPCToServer(${1:id_table},${2:...})",
        "description": " ※参数: \n   (id_table)<>[] \n   (...)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1508"
    },
    "全局.c_goto:UNKNOWN": {
        "prefix": "c_goto",
    ...
    "全局.RegisterInventoryItemAtlas:UNKNOWN": {
        ...
        "body": "RegisterInventoryItemAtlas(${1:atlas},${2:imagename})",
        "description": " ※参数: \n   (atlas)<>[] \n   (imagename)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/simutil 所在行数: 610"
    },
    "全局.RegisterSkilltreeIconsAtlas:UNKNOWN": {
        "prefix": "RegisterSkilltreeIconsAtlas",
        "body": "RegisterSkilltreeIconsAtlas(${1:atlas},${2:imagename})",
        "description": " ※参数: \n   (atlas)<>[] \n   (imagename)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/simutil 所在行数: 762"
    },
    ...
    "全局.GetTimeReal:UNKNOWN": {
        "prefix": "GetTimeReal",
        "body": "GetTimeReal(${1:})",
        "description": " ※参数: \n   ()<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 555"
    },
    ...
    "全局.GetClientModRPCHandler:UNKNOWN": {
        ...
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1587"
    },
    ...
    "全局.GetShardModRPC:UNKNOWN": {
        ...
        "description": " ※参数: \n   (namespace)<>[] \n   (name)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1603"
    },
    ...
    "全局.RunScript:UNKNOWN": {
        ...
        "description": " ※参数: \n   (filename)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 575"
    },
    ...
    "全局.SendModRPCToClient:UNKNOWN": {
        "prefix": "SendModRPCToClient",
        "body": "SendModRPCToClient(${1:id_table},${2:...})",
        "description": " ※参数: \n   (id_table)<>[] \n   (...)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1513"
    },
    "全局.c_find:UNKNOWN": {
        "prefix": "c_find",
    ...
    "全局.SendModRPCToShard:UNKNOWN": {
        "prefix": "SendModRPCToShard",
        "body": "SendModRPCToShard(${1:id_table},${2:...})",
        "description": " ※参数: \n   (id_table)<>[] \n   (...)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/networkclientrpc 所在行数: 1518"
    },
    ...
    "全局.GetDebugString:UNKNOWN": {
        ...
        "description": " ※参数: \n   ()<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/mainfunctions 所在行数: 607"
    },
    ...
    "全局.AddReplicableComponent:UNKNOWN": {
        ...
        "description": " ※参数: \n   (name)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/entityreplica 所在行数: 98"
    },
    ...
    "全局.AddUserCommand:UNKNOWN": {
        ...
        "body": "AddUserCommand(${1:name},${2:data})",
        "description": " ※参数: \n   (name)<>[] \n   (data)<>[] \n ※返回: \n ※说明: UNKNOWN\n ※贡献者: @\n ※路径: scripts/usercommands 所在行数: 516"
    },
    ...
    "全局.AddComponentAction:为某组件绑定动作.默认是为组件添加装备栏类型动作.": {
