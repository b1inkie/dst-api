data = {
    ...
    "components.SetDamageMultiplier:": {
    ...
    "components.SetIgnoreAcidRainTicks:": {
    ...
    "components.SetOverrideAcidRainTickFn:": {
    ...
    "components.SetOnStopIsRainingFn:": {
    ...
    "components.RegisterAttunedSource:": {
    ...
    "components.SetTriggerThreshold:": {
    ...
    "components.SetTimeEffectMultiplier:": {
    ...
    "components.OnClearBloomEffectHandle:": {
    ...
    "components.SetTargetRudderDirection:": {
    ...
    "components.SetCanSteeringRotate:": {
    ...
    "components.SetBoatraceStartedFn:": {
    ...
    "components.HasCharacterIngredient:": {
    ...
    "components.ConsumeTempTechBonuses:": {
    ...
    "components.ActivateCurrentResearchMachine:": {
    ...
    "components.OverrideBurnFXBuild:": {
    ...
    "components.UpdateMaxEmergencyCommit:": {
    ...
    "components.CanExtinguishTarget:": {
    ...
    "components.CalculateTrajectory:": {
    ...
    "components.CalculateMinimumSpeedForDistance:": {
    ...
    "components.SetHorizontalSpeedForDistance:": {
    ...
    "components.GetConstructionSite:": {
    ...
    "components.GetSlotForIngredient:": {
    ...
    "components.GetIngredientForSlot:": {
    ...
    "components.SetOnStartConstructionFn:": {
    ...
    "components.MoveItemFromHalfOfSlot:": {
    ...
    "components.SwapOneOfActiveItemWithSlot:": {
    ...
    "components.DropEverythingUpToMaxStacks:": {
    ...
    "components.DestroyContentsConditionally:": {
    ...
    "components.RegisterDayWalkerSpawningPoint:": {
    ...
    "components.StopLifting:": {
        "prefix": "components.dumbbelllifter:StopLifting",
        "body": "components.dumbbelllifter:StopLifting()",
        "description": "参数: 返回值:无返回值 贡献者:@"
    },
    "components.CanEat:检查实体是否可以吃指定食物": {
        "prefix": "components.edible:CanEat",
        "body": "components.edible:CanEat(${1:food})",
        "description": "参数:(food)<entity>[食物对象] 返回值:<boolean>[实体是否可以吃该食物] 贡献者:@764不是西红柿"
    },
    "components.OnRemoveFromEntity:当组件从实体中移除时调用的函数": {
        "prefix": "components.edible:OnRemoveFromEntity",
        "body": "components.edible:OnRemoveFromEntity()",
        "description": "参数: 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.Eat:实体吃掉指定的食物": {
        "prefix": "components.edible:Eat",
        "body": "components.edible:Eat(${1:food},${2:feeder})",
        "description": "参数:(food)<entity>[食物对象],(feeder)<entity>[喂食者对象] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.GetEdibleTags:获取实体可食用的食物标签列表": {
        "prefix": "components.edible:GetEdibleTags",
        "body": "components.edible:GetEdibleTags()",
        "description": "参数: 返回值:<table>[返回可食用的标签列表] 贡献者:@764不是西红柿"
    },
    "components.SetCanEatGears:设置实体可以食用齿轮": {
        "prefix": "components.edible:SetCanEatGears",
        "body": "components.edible:SetCanEatGears()",
        "description": "参数: 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.HasBeen:检查是否已经经过指定时间": {
        "prefix": "components.edible:HasBeen",
        "body": "components.edible:HasBeen(${1:time})",
        "description": "参数:(time)<number>[时间间隔] 返回值:<boolean>[是否经过指定时间] 贡献者:@764不是西红柿"
    },
    "components.SetCanEatHorrible:设置实体可以食用腐烂食物": {
        "prefix": "components.edible:SetCanEatHorrible",
        "body": "components.edible:SetCanEatHorrible()",
        "description": "参数: 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.TimeSinceLastEating:获取自上次进食以来的时间": {
        "prefix": "components.edible:TimeSinceLastEating",
        "body": "components.edible:TimeSinceLastEating()",
        "description": "参数: 返回值:<number>[返回自上次进食以来的时间] 贡献者:@764不是西红柿"
    },
    "components.PrefersToEat:检查实体是否优先选择吃该食物": {
        "prefix": "components.edible:PrefersToEat",
        "body": "components.edible:PrefersToEat(${1:food})",
        "description": "参数:(food)<entity>[食物对象] 返回值:<boolean>[是否优先食用] 贡献者:@764不是西红柿"
    },
    "components.SetAbsorptionModifiers:设置食物对健康、饥饿和理智的吸收倍率": {
        "prefix": "components.edible:SetAbsorptionModifiers",
        "body": "components.edible:SetAbsorptionModifiers(${1:health},${2:hunger},${3:sanity})",
        "description": "参数:(health)<number>[健康吸收倍率],(hunger)<number>[饥饿吸收倍率],(sanity)<number>[理智吸收倍率] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetPrefersEatingTag:设置实体优先食用指定标签的食物": {
        "prefix": "components.edible:SetPrefersEatingTag",
        "body": "components.edible:SetPrefersEatingTag(${1:tag})",
        "description": "参数:(tag)<string>[优先食用的标签] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.TestFood:测试食物是否符合某些条件": {
        "prefix": "components.edible:TestFood",
        "body": "components.edible:TestFood(${1:food},${2:testvalues})",
        "description": "参数:(food)<entity>[食物对象],(testvalues)<table>[测试值] 返回值:<boolean>[测试结果] 贡献者:@764不是西红柿"
    },
    "components.SetRefusesSpoiledFood:设置实体是否拒绝腐烂的食物": {
        "prefix": "components.edible:SetRefusesSpoiledFood",
        "body": "components.edible:SetRefusesSpoiledFood(${1:refuses})",
        "description": "参数:(refuses)<boolean>[是否拒绝腐烂食物] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetCanEatRawMeat:设置实体是否可以食用生肉": {
        "prefix": "components.edible:SetCanEatRawMeat",
        "body": "components.edible:SetCanEatRawMeat(${1:can_eat})",
        "description": "参数:(can_eat)<boolean>[是否可以食用生肉] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetDiet:设置食物种类和优先食用的类别": {
        "prefix": "components.edible:SetDiet",
        "body": "components.edible:SetDiet(${1:caneat},${2:preferseating})",
        "description": "参数:(caneat)<table>[可以食用的食物类别],(preferseating)<table>[优先食用的食物类别] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetOnEatFn:设置当实体吃掉食物时调用的函数": {
        "prefix": "components.edible:SetOnEatFn",
        "body": "components.edible:SetOnEatFn(${1:fn})",
        "description": "参数:(fn)<function>[吃掉食物时的回调函数] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetIgnoresSpoilage:设置实体是否忽略食物的腐烂状态": {
        "prefix": "components.edible:SetIgnoresSpoilage",
        "body": "components.edible:SetIgnoresSpoilage(${1:ignores})",
        "description": "参数:(ignores)<boolean>[是否忽略食物腐烂] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.DoFoodEffects:应用食物的效果到实体": {
        "prefix": "components.edible:DoFoodEffects",
        "body": "components.edible:DoFoodEffects(${1:food})",
        "description": "参数:(food)<entity>[食物对象] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetCanEatRaw:设置实体可以生吃食物": {
        "prefix": "components.edible:SetCanEatRaw",
        "body": "components.edible:SetCanEatRaw()",
        "description": "参数: 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetStrongStomach:设置实体是否拥有强胃（更耐腐烂食物）": {
        "prefix": "components.edible:SetStrongStomach",
        "body": "components.edible:SetStrongStomach(${1:is_strong})",
        "description": "参数:(is_strong)<boolean>[是否拥有强胃] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.SetCanEatNitre:设置实体是否可以食用硝石": {
        "prefix": "components.edible:SetCanEatNitre",
        "body": "components.edible:SetCanEatNitre(${1:can_eat})",
        "description": "参数:(can_eat)<boolean>[是否可以食用硝石] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.OnLoad:从保存数据中加载实体的状态信息": {
        "prefix": "components.edible:OnLoad",
        "body": "components.edible:OnLoad(${1:data})",
        "description": "参数:(data)<table>[加载的保存数据] 返回值:无返回值 贡献者:@764不是西红柿"
    },
    "components.OnSave:保存实体的状态信息": {
        "prefix": "components.edible:OnSave",
        "body": "components.edible:OnSave()",
        "description": "参数: 返回值:<table>[保存的数据表] 贡献者:@764不是西红柿"
    },
    "components.GetMultiplier:": {
    ...
    "components.SetPreventUnequipping:": {
    ...
    "components.ShouldPreventUnequipping:": {
    ...
    "components.SetLowerSailStrength:": {
    ...
    "components.GetStressDescription:": {
    ...
    "components.SetIgnoreCombatDurabilityLoss:": {
    ...
    "components.IgnoresCombatDurabilityLoss:": {
    ...
    "components.RemoveAllFocusSources:": {
    ...
    "components.SortAffinitiesByBonus:": {
    ...
    "components.RemoveFoodtypeAffinity:": {
    ...
    "components.InitializeFuelLevel:": {
    ...
    "components.GroundPound_Offscreen:": {
    ...
    "components.SetHealthAmount:设置一个治疗量x，在触发治疗后，恢复玩家血量x 治疗量默认值为 TUNING.HEALING_SMALL = 3": {
    ...
    "components.Heal:该方法在触发治疗时调用，该方法内会依次触发SetCanHealFn设置的判断和SetOnHealFn设置的触发方法，还会判断治疗目标本身的target.components.health.canheal，如果canheal=false,则依然会触发整个治疗流程并扣除治疗预制物，但目标不会加血。": {
        "prefix": "components.healer:Heal",
        "body": "components.healer:Heal(${1:doer},${2:target})",
        "description": "参数:(doer)<触发治疗的对象，一般是玩家。>[使用者],(target)<实体对象>[治疗目标] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.SetOnHealFn:设置一个方法，在触发治疗时，会触发该方法，例如：SetOnHealFn(function (inst, target,doer)  end)，inst是有该组件的预制物，target是治疗目标,doer是使用者": {
        "prefix": "components.healer:SetOnHealFn",
        "body": "components.healer:SetOnHealFn(${1:fn})",
        "description": "参数:(fn)<function>[方法] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.SetCanHealFn:传入一个方法，用于判断是否可以触发治疗。例如：SetCanHealFn(function (inst, target, doer) return false,'不准治疗他') inst是有该组件的预制物，target是治疗目标,doer是使用者": {
        "prefix": "components.healer:SetCanHealFn",
        "body": "components.healer:SetCanHealFn(${1:fn})",
        "description": "参数:(fn)<function>[方法] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.DeltaPenalty:": {
        "prefix": "components.health:DeltaPenalty",
        "body": "components.health:DeltaPenalty(${1:delta})",
        "description": "参数:(delta)<>[] 返回值:无返回值 贡献者:@"
    },
    "components.SetMaxDamageTakenPerHit:": {
    ...
    "components.ShouldShowIndicator:": {
    ...
    "components.FinishRemovingEntity:": {
    ...
    "components.SetOverrideStarveFn:": {
    ...
    "components.CreateNewAndOrShowCurrentGame:": {
    ...
    "components.BurnNonpotatableInContainer:": {
    ...
    "components.GetOpenContainerProxyFor:": {
    ...
    "components.ControllerUseItemOnSceneFromInvTile:": {
    ...
    "components.ControllerUseItemOnSelfFromInvTile:": {
    ...
    "components.InheritWorldWetnessAtTarget:": {
    ...
    "components.MakeMoistureAtLeast:": {
    ...
    "components.GetPredictExternalSpeedMultipler:": {
    ...
    "components.ScanForPlatformInDir:": {
    ...
    "components.SetExternalSpeedMultiplier:": {
    ...
    "components.PushTempGroundSpeedMultiplier:": {
    ...
    "components.GetExternalSpeedMultiplier:": {
    ...
    "components.RemoveExternalSpeedMultiplier:": {
    ...
    "components.UpdateGroundSpeedMultiplier:": {
    ...
    "components.TriggerWagstaffAppearance:": {
    ...
    "components.HasDefeatedAllMutations:": {
    ...
    "components.GetNumDefeatedMutations:": {
    ...
    "components.RefreshDefeatedMutationsTable:": {
    ...
    "components.setHerdsOnPlantable:": {
    ...
    "components.SetGroundOnlyMachine:": {
    ...
    "components.CanDeployWalkablePeripheralAtPoint:": {
    ...
    "components.CheckForBadThingsInOceanArena:": {
    ...
    "components.ClearGoodArenaPoints:": {
    ...
    "components.HasAdjacentLandTile:": {
    ...
    "components.CanDeployBoatAtPointInWater:": {
    ...
    "components.CanPlacePrefabFilteredAtPoint:": {
    ...
    "components.FindRandomPointInOcean:": {
    ...
    "components.IsSurroundedByWater:": {
    ...
    "components.IsAboveGroundAtPoint:": {
    ...
    "components.FindBestSpawningPointForArena:": {
    ...
    "components.CalculateMightiness:": {
    ...
    "components.SetWaterproofInventory:": {
    ...
    "components.SetMoonstormSpeedMultiplier:": {
    ...
    "components.OnRegisterNightLight:": {
    ...
    "components.FindClosestNightLightFromListToInst:": {
    ...
    "components.GetNightLightsWithFilter:": {
    ...
    "components.IsNightLightDataInAnyTag:": {
    ...
    "components.UpdateNightLightPosition:": {
    ...
    "components.UpdateClientMaxCastDistance:": {
    ...
    "components._LaunchFishProjectile:": {
    ...
    "components.AddValidHealingCause:": {
    ...
    "components.SetOnlySpawnOffscreen:": {
    ...
    "components.TakeOversizedPicture:": {
    ...
    "components.GetCannonAimActions:": {
    ...
    "components.GetPointSpecialActions:": {
    ...
    "components.GetInventoryActions:": {
    ...
    "components.UnregisterContainer:": {
    ...
    "components.GetEquippedItemActions:": {
    ...
    "components.OnUpdateActionFilterStack:": {
    ...
    "components.DoControllerInspectItemFromInvTile:": {
    ...
    "components.GetGroundUseSpecialAction:": {
    ...
    "components.DoControllerUseItemOnSelfFromInvTile:": {
    ...
    "components.RemoteControllerUseItemOnItemFromInvTile:": {
    ...
    "components.RemoteResurrectButton:": {
    ...
    "components.OnRemoteControllerAltActionButton:": {
    ...
    "components.OnRemoteControllerActionButtonPoint:": {
    ...
    "components.DoClientBusyOverrideLocomote:": {
    ...
    "components.GetPlatformRelativePosition:": {
    ...
    "components.GetSceneItemControllerAction:": {
    ...
    "components.OnRemoteToggleMovementPrediction:": {
    ...
    "components.RemoteMakeRecipeFromMenu:": {
    ...
    "components.RemotePausePrediction:": {
    ...
    "components.CycleControllerAttackTargetForward:": {
    ...
    "components.OnRemoteControllerAttackButton:": {
    ...
    "components.OnLocomotorBufferedAction:": {
    ...
    "components.RemoteCastSpellBookFromInv:": {
    ...
    "components.HasGroundUseSpecialAction:": {
    ...
    "components.DoControllerDropItemFromInvTile:": {
    ...
    "components.GetActionButtonAction:": {
    ...
    "components.RemoteDropItemFromInvTile:": {
    ...
    "components.IsControllerTargetingModifierDown:": {
    ...
    "components.RemoteBufferedAction:": {
    ...
    "components.RemotePredictOverrideLocomote:": {
    ...
    "components.CooldownRemoteController:": {
    ...
    "components.Schedule:设置定时任务的时间间隔，因为该组件是通过定时检测周围玩家来实现的。一般不用修改。": {
        "prefix": "components.playerprox:Schedule",
        "body": "components.playerprox:Schedule(${1:new_period})",
        "description": "参数:(new_period)<number>[定时任务间隔] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.Stop:停止定时任务检测，一般不用修改": {
        "prefix": "components.playerprox:Stop",
        "body": "components.playerprox:Stop()",
        "description": "参数: 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.SetTargetMode:设置检测目标的模式，共有五种，在playerprox.lua组件的TargetModes表中，分别为：AllPlayers、AnyPlayer、SpecificPlayer、LockOnPlayer、LockAndKeepPlayer，具体区别等大佬补充，一般用AllPlayers即可。": {
        "prefix": "components.playerprox:SetTargetMode",
        "body": "components.playerprox:SetTargetMode(${1:mode},${2:target},${3:override})",
        "description": "参数:(mode)<>[],(target)<>[],(override)<>[] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.IsPlayerClose:": {
        "prefix": "components.playerprox:IsPlayerClose",
        "body": "components.playerprox:IsPlayerClose()",
        "description": "参数: 返回值:无返回值 贡献者:@"
    },
    "components.SetOnPlayerNear:设置当玩家靠近时会触发的方法，例如：SetOnPlayerNear(function(inst, player) end) inst是有该组件的预制物，player是靠近的玩家。": {
        "prefix": "components.playerprox:SetOnPlayerNear",
        "body": "components.playerprox:SetOnPlayerNear(${1:fn})",
        "description": "参数:(fn)<function>[方法] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.SetOnPlayerFar:设置当玩家远离时触发的方法，例如：SetOnPlayerFar(function(inst, player) end) inst是有该组件的预制物，player是远离的玩家。": {
        "prefix": "components.playerprox:SetOnPlayerFar",
        "body": "components.playerprox:SetOnPlayerFar(${1:fn})",
        "description": "参数:(fn)<function>[方法] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.SetLostTargetFn:": {
    ...
    "components.SetPlayerAliveMode:设置玩家的触发模式，有三种，在playerprox.lua组件的AliveModes表里，分别为 AliveOnly（只有活着的）、DeadOnly（只有死了的）、DeadOrAlive（死活都可以）": {
        "prefix": "components.playerprox:SetPlayerAliveMode",
        "body": "components.playerprox:SetPlayerAliveMode(${1:alivemode})",
        "description": "参数:(alivemode)<boolean>[触发模式] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.GetDebugString:打印日志，这里会返回玩家距离远还是近": {
    ...
    "components.SetActiveRadius_Internal:": {
    ...
    "components.Teleport_GetNearbyItems:": {
    ...
    "components.SetReviveSpeedMultForTag:": {
    ...
    "components.WillInduceCooldownOnActivate:": {
    ...
    "components.SetForcedInduceCooldownOnActivate:": {
    ...
    "components.TryToDoRoseInspectionOnTarget:": {
    ...
    "components.TryToDoRoseInspectionOnPoint:": {
    ...
    "components.SetPlayerGhostImmunity:": {
    ...
    "components.AddSanityAuraImmunity:": {
    ...
    "components.SetIgnoreMovingFast:": {
    ...
    "components.GetNamesFromSkillSelection:": {
    ...
    "components.GetSpellCooldownPercent:": {
    ...
    "components.RestartSpellCooldown:": {
    ...
    "components.SetOnToggleFn:": {
        "prefix": "components.toggleableitem:SetOnToggleFn",
        "body": "components.toggleableitem:SetOnToggleFn(${1:fn})",
        "description": "参数:(fn)<>[] 返回值:无返回值 贡献者:@"
    },
    "components.GetEffectiveness:": {
        "prefix": "components.worker:GetEffectiveness",
        "body": "components.worker:GetEffectiveness(${1:action})",
        "description": "参数:(action)<>[] 返回值:无返回值 贡献者:@"
    },
    "components.CanDoAction:判断是否可以有某种工具的功能，比如CanDoAction(ACTIONS.CHOP) 判断它是否有砍的功能": {
        "prefix": "components.tool:CanDoAction",
        "body": "components.tool:CanDoAction(${1:action})",
        "description": "参数:(action)<ACTION>[工具动作类型] 返回值:<boolean>[是否有action的工具动作类型] 贡献者:@御坂十七号"
    },
    "components.CanDoToughWork:": {
        "prefix": "components.tool:CanDoToughWork",
        "body": "components.tool:CanDoToughWork()",
        "description": "参数: 返回值:<boolean>[返回该工具是否可以在困难模式下工作] 贡献者:@御坂十七号"
    },
    "components.SetAction:设置工作类型和效率，工具类型有:ACTIONS.CHOP、ACTIONS.DIG、ACTIONS.HAMMER、ACTIONS.MINE、ACTIONS.NET、ACTIONS.PLAY、ACTIONS.UNSADDLE、ACTIONS.REACH_HIGH、ACTIONS.SCYTHE, 比如粗壮常青树需要砍15次，普通斧效率为1，月光玻璃斧效率为2.5，普通斧头要砍15次，月光玻璃斧只要6次。": {
        "prefix": "components.tool:SetAction",
        "body": "components.tool:SetAction(${1:action},${2:effectiveness})",
        "description": "参数:(action)<ACTION>[工具动作类型],(effectiveness)<number>[效率] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.EnableToughWork:是否可以在困难模式下工作，传入true就可以豁免workable组件中tough的影响，比如亮茄粉碎者就调用了inst.components.tool:EnableToughWork(true)": {
        "prefix": "components.tool:EnableToughWork",
        "body": "components.tool:EnableToughWork(${1:tough})",
        "description": "参数:(tough)<boolean>[困难的] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.IsUsed:": {
    ...
    "components.SetInventoryDisable:": {
    ...
    "components.RemovePlayerOnPlatform:": {
    ...
    "components.SpreadProtectionAtPoint:": {
    ...
    "components.SetDamage:如果dmg为函数型参数，show me等信息模组无法显示正确的攻击力": {
    ...
    "components.GetAllWinonaTeleportPads:": {
    ...
    "components.GetWorkAction:返回这个对象可以被哪种动作触发，比如建筑一般可以被锤子锤，那就会返回 ACTIONS.HAMMER": {
        "prefix": "components.workable:GetWorkAction",
        "body": "components.workable:GetWorkAction()",
        "description": "参数: 返回值:<action>[被触发的动作类型] 贡献者:@御坂十七号"
    },
    "components.SetOnLoadFn:设置一个方法，当该组件被加载时触发。一般在世界从存档中恢复时用。": {
        "prefix": "components.workable:SetOnLoadFn",
        "body": "components.workable:SetOnLoadFn(${1:fn})",
        "description": "参数:(fn)<function>[方法] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.SetOnFinishCallback:设置一个方法，当全部次数消耗完毕后会触发，比如，一个箱子被锤两次后破坏掉，那锤两次后就会触发fn。例如：SetOnFinishCallback(function(inst,worker)end) inst是自身，worker是触发最后一次操作的对象。": {
        "prefix": "components.workable:SetOnFinishCallback",
        "body": "components.workable:SetOnFinishCallback(${1:fn})",
        "description": "参数:(fn)<function>[方法] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.SetWorkMultiplierFn:": {
    ...
    "components.SetWorkLeft:表示需要被操作多少次才触发最终结果的 onfinish 方法，": {
        "prefix": "components.workable:SetWorkLeft",
        "body": "components.workable:SetWorkLeft(${1:work})",
        "description": "参数:(work)<number>[被操作的次数] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.ShouldRecoil:": {
    ...
    "components.SetOnWorkCallback:设置一个方法，当该对象被操作时触发，比如建筑可以被锤，那建筑被锤的时候就会触发这个方法。每锤一下就会触发一次,例如：SetOnWorkCallback(function(inst, worker, workleft, numworks)end) inst是有该组件的预制物，worker是触发该操作的对象，workleft是剩余可操作次数，numworks是本次操作扣除了几次操作次数。": {
        "prefix": "components.workable:SetOnWorkCallback",
        "body": "components.workable:SetOnWorkCallback(${1:fn})",
        "description": "参数:(fn)<function>[方法] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.WorkedBy_Internal:": {
        "prefix": "components.workable:WorkedBy_Internal",
        "body": "components.workable:WorkedBy_Internal(${1:worker},${2:numworks})",
        "description": "参数:(worker)<>[],(numworks)<>[] 返回值:无返回值 贡献者:@"
    },
    "components.SetRequiresToughWork:当设置为true时，则启用了困难模式，一般的操作动作会被弹开不消耗次数。只有拥有强力模式的工具或人物才可以。比如裂隙晶体、绝望石柱之类的。": {
        "prefix": "components.workable:SetRequiresToughWork",
        "body": "components.workable:SetRequiresToughWork(${1:tough})",
        "description": "参数:(tough)<boolean>[困难模式] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.GetDebugString:返回字符串日志": {
        "prefix": "components.workable:GetDebugString",
        "body": "components.workable:GetDebugString()",
        "description": "参数: 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.CanBeWorked:返回该对象是否可以被操作，这里面会判断workable（是否可用） 和workleft（次数）": {
        "prefix": "components.workable:CanBeWorked",
        "body": "components.workable:CanBeWorked()",
        "description": "参数: 返回值:<boolean>[是否可以被操作] 贡献者:@御坂十七号"
    },
    "components.SetMaxWork:设置该对象最大可以被操作的次数，最小为1，当调用SetWorkLeft时设置的次数不会超过SetMaxWork设置次数": {
        "prefix": "components.workable:SetMaxWork",
        "body": "components.workable:SetMaxWork(${1:work})",
        "description": "参数:(work)<number>[次数] 返回值:无返回值 贡献者:@御坂十七号"
    },
    "components.OnLoad:返回被保存的表数据，一般不用管": {
        "prefix": "components.workable:OnLoad",
        "body": "components.workable:OnLoad(${1:data})",
        "description": "参数:(data)<>[] 返回值:<table>[表] 贡献者:@御坂十七号"
    },
    "components.CanDoAction:": {
        "prefix": "components.worker:CanDoAction",
        "body": "components.worker:CanDoAction(${1:action})",
        "description": "参数:(action)<>[] 返回值:无返回值 贡献者:@"
    },
    "components.SetAction:": {
    ...
    "components.ResolveSpecialWorkAmount:": {
    ...
    "components.SetSpecialMultiplierFn:": {
    ...
    "components.IsDestinationForPortal:": {
    ...
    "components.OnUnequipSkinnedItem:": {
    ...
    "components.DumpIndividualPlayerStats:": {
    ...
    "components.GetParameterLineDoll:": {
