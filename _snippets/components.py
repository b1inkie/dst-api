data = {
    ...
    "组件.Has:容器内是否有指定数量的指定物品及其数目": {
        ...
        "description": "※参数: (item)<str>[物品prefab名] (amount)<num>[最低数量] (iscrafting)<bool|nil>[区分标签nocrafting] ※返回: <bool>[容器内有指定数量的指定物品] <num>[库存数量] ※说明: 容器内是否有指定数量的指定物品及其数目 ※贡献者: @Runar"
    },
    "组件.EnableInfiniteStackSize:启用或关闭容器无限堆叠": {
        ...
        "description": "※参数: (enable)<bool>[启用无限堆叠] ※返回: ※说明: 启用或关闭容器无限堆叠 ※贡献者: @Runar"
    },
    ...
    "组件.HasItemWithTag:容器内是否有指定数量的指定物品及其数目": {
        ...
        "description": "※参数: (tag)<str>[标签] (amount)<num>[最低累计数量] ※返回: <bool>[容器内有指定数量的指定物品] <num>[库存数量] ※说明: 容器内是否有指定数量的指定物品及其数目 ※贡献者: @Runar"
    },
    ...
    "组件.ConsumeByName:按数量扣除指名物品": {
        ...
        "description": "※参数: (item)<str>[物品prefab名] (amount)<num>[扣除数量] ※返回: ※说明: 按数量扣除指名物品 ※贡献者: @Runar"
    },
    "组件.GetWidget:获取容器UI": {
    ...
    "组件.GetItemByName:获取容器内指名物品列表": {
        ...
        "description": "※参数: (item)<str>[物品prefab名] (amount)<num>[所需库存数量] ※返回: <tbl>[物品inst为键, 值为获取数量的表] ※说明: 获取容器内指名物品列表 ※贡献者: @Runar"
    },
    "组件.GetItemsWithTag:获取容器内指定标签的物品列表": {
        ...
        "description": "※参数: (tag)<str>[标签] ※返回: <tbl>[符合条件的物品列表] ※说明: 获取容器内指定标签的物品列表 ※贡献者: @Runar"
    },
    "组件.HasItemThatMatches:容器内是否有指定数量的指定物品及其数目": {
        ...
        "description": "※参数: (fn)<fn>[物品测试函数]{参数:(item)<ent>[物品] 返回:<bool>[符合条件]} (amount)<num>[最低累计数量] ※返回: <bool>[容器内有指定数量的指定物品] <num>[库存数量] ※说明: 容器内是否有指定数量的指定物品及其数目 ※贡献者: @Runar"
    },
    ...
    "组件.SetPerishRateMultiplier:设置腐败率乘函系数": {
        ...
        "description": "※参数: (rate)<fn|num>[腐败率乘函系数]{参数:(inst)<ent>[容器inst] (item)<ent>[物品inst] 返回:<num>[腐败率乘系数]} ※返回: ※说明: 设置腐败率乘函系数 ※贡献者: @Runar"
    },
    "组件.GetPerishRateMultiplier:获取腐败率乘系数": {
        ...
        "description": "※参数: (item)<ent>[物品inst] ※返回: <num>[腐败率乘系数] ※说明: 获取腐败率乘系数 ※贡献者: @Runar"
    },
