data = {
    ...
    "组件.DestroyContents:无条件销毁容器内所有物品": {
        ...
        "description": " ※参数: (onpredestroyitemcallbackfn)<fn|nil>[物品销毁预回调函数]\n   {参数:\n      (inst)<ent>[容器] \n      (item)<ent>[要销毁的物品] \n   返回:} \n ※返回: \n ※说明: 无条件销毁容器内所有物品\n ※贡献者: @Runar"
    },
    "组件.CanOpen:容器可被打开": {
    ...
    "组件.DestroyContentsConditionally:销毁容器内满足条件的所有物品": {
        ...
        "description": " ※参数: (filterfn)<fn|nil>[销毁条件]\n   {参数:\n      (inst)<ent>[容器] \n      (item)<ent>[要测试的物品] \n   返回:} (onpredestroyitemcallbackfn)<fn|nil>[物品销毁预回调函数]\n   {参数:\n      (inst)<ent>[容器] \n      (item)<ent>[要销毁的物品] \n   返回:} \n ※返回: \n ※说明: 销毁容器内满足条件的所有物品\n ※贡献者: @Runar"
    },
    ...
    "组件.SetPerishRateMultiplier:设置腐败率乘函系数": {
        ...
        "description": " ※参数: (rate)<fn|num>[腐败率乘函系数]\n   {参数:\n      (inst)<ent>[容器inst] \n      (item)<ent>[物品inst] \n   返回:\n      <num>[腐败率乘系数]} \n ※返回: \n ※说明: 设置腐败率乘函系数\n ※贡献者: @Runar"
    },
    "组件.Construct:": {
