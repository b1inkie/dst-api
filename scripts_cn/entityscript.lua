return {
	...
	["StartUpdatingComponent"] = {
		params = {
			{param = "cmp", explain = "", type = ""},
			{param = "do_static_update", explain = "", type = ""},
	...
	["StopUpdatingComponent_Deferred"] = {
		params = {
			{param = "cmp", explain = "", type = ""},
	...
	["IsOnPassablePoint"] = {
		params = {
			...
			{param = "floating_platforms_are_not_passable", explain = "", type = ""},
	...
	["SetClientSideInventoryImageOverride"] = {
		params = {
			{param = "flagname", explain = "", type = ""},
			{param = "srcinventoryimage", explain = "", type = ""},
			{param = "destinventoryimage", explain = "", type = ""},
			{param = "destatlas", explain = "", type = ""},
	...
	["AddDebuff"] = {
		params = {
			...
			{param = "data", explain = "", type = ""},
			{param = "skip_test", explain = "", type = ""},
			{param = "pre_buff_fn", explain = "", type = ""},
